      ...
      <section className="relative z-20 flex-1 flex flex-col justify-between px-4 py-8 sm:px-6 h-full">
        ...
        <div className="flex flex-col items-center justify-center w-full max-w-5xl mx-auto -mt-10">
          ...
          <div className="text-center space-y-2 group">
            <h1 className="cursor-target text-5xl xs:text-6xl sm:text-7xl md:text-8xl lg:text-9xl font-bold tracking-tighter transition-all duration-500 hover:tracking-wide hover:text-cyan-300 hover:drop-shadow-[0_0_30px_rgba(34,211,238,0.5)]">
              BRAINSTORM
            </h1>
